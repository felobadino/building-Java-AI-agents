...
/**
 * Here is used the LoopAgent class for iterating in the refactor of a generated code.
 */
public class CodeRefiner {
    public static void main(String[] args) {
        ...
        // In the instruction part of this agent is used feedback?. The ? means that in the
        // beginning when the code-generator agent is executed, it wasn't any feedback and
        // the compiler throw an error if we not include the ? at the end of this parameter
        // The idea is passing to compiler an empty string as a feedback avoiding the error.
