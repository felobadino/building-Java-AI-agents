...
/**
 * Here the idea is to use multiple agents in parallel by using the ParallelAgent class that
 * let you run some subagents in parallel. The example use web search through GoogleSearchTool
 * for investigating a specific company given by the user. One the information is ready then
 * another agent is in charge of gathering that information in a brief summary.
 */
